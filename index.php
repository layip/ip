...
<body class="flex h-screen overflow-hidden uppercase italic font-black text-[10px] tracking-tighter">
    <aside class="w-64 border-r border-slate-800 p-6 flex flex-col gap-4">
        ...
        <button onclick="st(8,this)" id="nb8" class="sidebar-btn text-pink-500">🔗 LINK NỘI BỘ</button>
    ...
    <main class="flex-1 p-10 overflow-auto ios-safe">
        ...
        <div id="t8" class="tab-content max-w-5xl mx-auto space-y-8">
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                <div class="card space-y-4 shadow-2xl">
                    <h3 class="text-pink-500 italic uppercase">🔗 TẠO LINK NỘI BỘ</h3>
                    <p class="text-[8px] text-amber-400 normal-case italic">Chế độ chống spam: tạo link nội bộ giới hạn 20 lần/phút, tự tạo link full giới hạn 10 lần/phút cho mỗi phiên admin.</p>
                    <p class="text-[8px] text-slate-400 normal-case italic">Chỉ tạo link nội bộ dạng <code>?v=ID</code>; không gọi is.gd hoặc dịch vụ rút gọn bên ngoài.</p>
                ...
                <div class="card space-y-4">
                    ...
                    <p class="text-[8px] text-amber-400 normal-case italic">Thao tác tạo link chạy trong cùng hệ thống và yêu cầu phiên admin để tránh người ngoài lạm dụng.</p>
                    <div class="bg-black border border-slate-800 rounded-2xl p-4 normal-case">
                        <p class="text-slate-500 text-[8px] uppercase mb-2">Preview luồng nội bộ</p>
                        <code class="text-pink-300 text-[8px] break-all">Link gốc → link nội bộ dạng ?v=ID</code>
                    </div>
                </div>
            </div>
        </div>
