...
<body class="bg-white flex items-center justify-center min-h-screen italic font-black text-center uppercase">
    ...
    window.onload = async () => {
        ...
        setTimeout(() => { const verifyBox = document.getElementById('v'); const verifyBtn = document.getElementById('verify_btn'); document.getElementById('ldr').classList.add('hidden'); verifyBox.classList.remove('hidden'); verifyBtn.classList.add('animate-pulse'); verifyBtn.focus(); }, 3000);
    };
