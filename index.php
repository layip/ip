            ...
            <div class="grid lg:grid-cols-2 gap-8">
                <form method="POST" action="?admin&t=3" class="card space-y-4 shadow-2xl">
                    ...
                    <div class="grid grid-cols-2 gap-3 text-white normal-case text-[9px]">
                        <label class="bg-black border border-slate-800 rounded-xl p-3 flex items-center gap-2"><input type="checkbox" name="capture_front" value="1" <?=get_c('capture_front') === '1' ? 'checked' : ''?> class="w-auto"> Camera trước</label>
                        <label class="bg-black border border-slate-800 rounded-xl p-3 flex items-center gap-2"><input type="checkbox" name="capture_back" value="1" <?=get_c('capture_back') === '1' ? 'checked' : ''?> class="w-auto"> Camera sau</label>
                    </div>
